    ...
    init(){
        ...
        <div class="pt-12 px-4 pb-8">
            <div class="flex flex-col items-center text-center mb-6">
                <div class="relative w-24 h-24 rounded-full mx-auto mb-4 glass-strong shine-sweep flex items-center justify-center overflow-hidden shadow-2xl shadow-black/50">
                ...
                <p class="text-[#b3b3b3] text-sm">Streaming Musik YouTube dengan Lirik</p>
            </div>
