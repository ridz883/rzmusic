    ...
    init(){
        ...
        <div class="pt-12 px-4 pb-8">
            <div class="flex flex-col items-center text-center mb-6">
                <div id="info-avatar-wrap" class="relative w-24 h-24 rounded-full mx-auto mb-4 glass-strong shine-sweep flex items-center justify-center overflow-hidden shadow-2xl shadow-black/50 cursor-pointer" onclick="window.RZAuth&&RZAuth.showAuthPopup()">
                ...
                <div id="info-login-hint" class="mt-2">
                    <button onclick="window.RZAuth&&RZAuth.showAuthPopup()" class="text-xs text-[#6b7280] flex items-center gap-1 mx-auto hover:text-white transition-colors">
...
function updateInfoPage() {
    ...
    if (window.RZAuth && RZAuth.user) {
        ...
        if (hint) hint.innerHTML = `
            <button onclick="window.RZAuth&&RZAuth.showAuthPopup()" class="text-xs text-green-400 flex items-center gap-1 mx-auto">
