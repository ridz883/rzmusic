...
window.RZAuth = {
    ...
    async init() {
        ...
        } catch(e) { console.error('RZAuth.init error:', e); }
    },
    ...
    async uploadPhoto(file) {
        ...
        try {
            ...
            const path = `${RZAuth.user.id}/avatar.${ext}`;
            ...
            await supabase.from('profiles').update({ custom_photo_url: url }).eq('user_id', RZAuth.user.id);
...
// Override stub yang dipasang di index.html
window.RZAuth = RZAuth;
RZAuth.init();
