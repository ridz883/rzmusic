    ...
    init(){
        ...
        <div id="full-player" class="fixed flex flex-col z-[100]" style="display:none;background:rgba(5,5,7,0.92);backdrop-filter:blur(28px);-webkit-backdrop-filter:blur(28px);transition:transform 0.35s ease-out;transform:translateY(100%);top:0;left:0;width:100%;height:100%;overflow:hidden;touch-action:none;">
            ...
            <div class="relative z-10 flex-1 flex items-center justify-center px-8" style="min-height:0;overflow:hidden;">
                <div class="relative w-full max-w-[300px] aspect-square"><img id="full-cover" src="" class="w-full h-full object-cover rounded-3xl shadow-2xl shadow-black/50 transition-transform duration-500 vinyl-paused" style="border-radius:50%;box-shadow:0 0 0 8px rgba(255,255,255,0.05),0 20px 60px rgba(0,0,0,0.8);" /></div>
            </div>
        ...
        <div id="lyrics-overlay" class="fixed flex flex-col z-[200]" style="display:none;background:transparent;transition:transform 0.35s ease-out;transform:translateY(100%);top:0;left:0;width:100%;height:100%;overflow:hidden;touch-action:none;">
