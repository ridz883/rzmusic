const FullPlayer={
    init(){
        ...
        <div id="lyrics-overlay" class="fixed flex flex-col z-[200]" style="display:none;background:rgba(0,0,0,0.45);backdrop-filter:blur(60px);-webkit-backdrop-filter:blur(60px);transition:transform 0.35s ease-out;transform:translateY(100%);top:0;left:0;width:100%;height:100%;overflow:hidden;touch-action:none;">
