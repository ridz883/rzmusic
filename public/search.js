const Search={
    ...
    renderHistory(){
        ...
        h.map(function(q){
            ...
            return '<div class="search-history-item">'+
                ...
                '<span class="flex-1 text-sm text-white truncate" onclick="selectHistory(\''+safe+'\')">'+q+'</span>'+
    ...
    show(loading){
        ...
        c.innerHTML=S.sr.map(function(t,i){
            ...
            '<img src="'+t.cover+'" class="w-12 h-12 rounded-lg object-cover" onerror="this.src=\''+FI+'\'" />'+
